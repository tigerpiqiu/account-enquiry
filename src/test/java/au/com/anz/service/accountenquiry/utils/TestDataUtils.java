...
public class TestDataUtils {
    ...
    public static void insertAccountRecord(JdbcTemplate jdbcTemplate, long accountNumber, String accountName, String accountType,
    ...
    public static void insertTransactionRecord(JdbcTemplate jdbcTemplate, long accountNumber, String valueDate, AccountTransactionType accountTransactionType,
    ...
    private static String getInsertTransactionSql(long accountNumber, String valueDate, AccountTransactionType accountTransactionType,
                                                  BigDecimal transactionAmount, String transactionNarrative) {
